...
class AppColors {
  static const Color primaryColor = Color(0xFFE58901);
  //Shades of primary color
  static const Color primary200 = Color(0xFFE58901);
  static const Color primary300 = Color(0xFFE58901);

  static const vulcan = Color(0xFF1C1421);
  static const royalBlue = Color(0xFF604FEF);
  static const violet = Color(0xFF27073D);
